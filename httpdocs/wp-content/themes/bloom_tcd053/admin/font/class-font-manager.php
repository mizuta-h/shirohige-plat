      ...
      foreach( $font_list as $font_key => $font_item ){
        ...
        if( $font_key !== 'logo' ){
          $this->admin_font_labels[$font_key] = sprintf(
            '%s, %s',
            $this->get_font_value( $font_item_japan, 'label' ) ?: __( 'Japanese (unspecified)','tcd-w' ),
            $this->get_font_value( $font_item_latin, 'label' ) ?: __( 'Latin (unspecified)','tcd-w' ),
          );
        }
