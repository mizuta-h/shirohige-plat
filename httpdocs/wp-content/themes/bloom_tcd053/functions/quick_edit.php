...
<fieldset class="inline-edit-col-right">
	<div class="inline-edit-col column-recommend">
		<div class="inline-edit-group">
			...
			<label><input type="checkbox" name="pickup_post" value="on"><?php _e( 'Show this post for pickup post.', 'tcd-w' ); ?></label>
		</div>
	</div>
</fieldset>
<?php
...
function custom_quick_edit_values( $actions, $post ) {
	...
	if ( $post->post_type == 'post' ) {
		$meta_keys = array_merge( $meta_keys, array( 'recommend_post', 'recommend_post2', 'pickup_post' ) );
	}
