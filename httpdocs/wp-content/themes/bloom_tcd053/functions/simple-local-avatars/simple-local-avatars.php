...
class Simple_Local_Avatars {
	...
	public function __construct() {
		load_plugin_textdomain( 'simple-local-avatars', false, dirname( __FILE__ ) . '/localization/' );
	 ...
	 */
	public function get_avatar( $avatar = '', $id_or_email = null, $size = 96, $default = '', $alt = '' ) {
	...
	public function admin_enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script( 'simple-local-avatars', str_replace( get_template_directory(), get_template_directory_uri(), dirname( __FILE__ ) ) . '/simple-local-avatars' . $script_name_append . '.js', array('jquery'), false, true );
...
endif;	// if ( ! class_exists('Simple_Local_Avatars') ) :
